...
*/
  ...
  agregar_usuario(usuario: {
    ...
    if (usuario.contrasenia == usuario.confirmarContrasena) {
      ...
      let direccion = "https://localhost:7274/api/Usuarios/Agregar_Usuario";
...
*/
  delete(usuario: any) {
    ...
    return this.http.delete("https://localhost:7274/api/Personas/Eliminar_Persona?id_persona=" + this.id_fracc).subscribe(
      () => {
        this.fetchDataUsers(this.dataService.obtener_usuario(1));
        console.log("hola");
        this.UserGroup.reset();
